    ...
    <div id="myContent" style="overflow: hidden">
     ...
     <div id="btn_group" class="btn-group-vertical btn-group-lg" role="group">
  	...
  	<center><br/>
		...
		<div id="tabEdit" class="easyui-dialog"  data-options="closed:true" style="align:center;width:830px;height:540px;padding:10px 60px 20px 60px">
			<form id="frmEdit">
				...
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				机加池编号 &nbsp; : &nbsp; 
				<input class="easyui-validatebox textbox" id="PoolID"  name="poolEvaluate.PoolID" 
					style="width:200px;height:25px" data-options="required:true,missingMessage:'请输入机加池编号'" />
				<br/><br/>
				
				&nbsp; &nbsp; &nbsp;
				PAC投加量 :&nbsp;
				<input class="easyui-numberbox textbox" style="width:200px;height:25px" id="PAC" name="poolEvaluate.PAC"
					   data-options="prompt:'请输入PAC投加量.',precision:2">
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				
				FeCl3投加量 :&nbsp;		
				<input class="easyui-numberbox textbox" style="width:200px;height:25px"  id="FeCl3" name="poolEvaluate.FeCl3"
					   data-options="prompt:'请输入FeCl3投加量.',precision:2" />
						<br/><br/>
									
				&nbsp; &nbsp; &nbsp;
				开 &nbsp;启&nbsp; 度 : &nbsp; &nbsp; 
				<input class="easyui-numberbox textbox" style="width:200px;height:25px"  id="OpenDegree" name="poolEvaluate.OpenDegree" 
					   data-options="prompt:'',precision:2" />
				&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				转 &nbsp; &nbsp; &nbsp; &nbsp; 速 : &nbsp; 
				<input class="easyui-numberbox"  style="width:210px;height:25px" id="RotationSpeed" name="poolEvaluate.RotationSpeed"
					   data-options="prompt:'',precision:2"  />
				<br/><br/>
				
				&nbsp; &nbsp; &nbsp;
				沉 &nbsp;降 &nbsp;比 : &nbsp; &nbsp;
				<input class="easyui-numberbox" style="width:200px;height:25px"  id="SV" name="poolEvaluate.SV" 
					data-options="prompt:'',precision:2" />
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				小斗排泥时长 : &nbsp;
				<input class="easyui-numberbox" style="width:190px;height:25px"  id="SmallMudFre" name="poolEvaluate.SmallMudFre" 
					data-options="prompt:'',precision:2" />
				<br/><br/>
				
				&nbsp; &nbsp; &nbsp;
				大斗排泥时长 :&nbsp;
				<input class="easyui-numberbox"  style="width:190px;height:25px" id="BigMudFre" name="poolEvaluate.BigMudFre"
					data-options="prompt:'',precision:2"  />
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				原 水 浊 度 : &nbsp;&nbsp;
				<input class="easyui-numberbox"  style="width:200px;height:25px" id="NTU" name="poolEvaluate.NTU"
					data-options="prompt:'',precision:2"  />
				<br/><br/>
				...
				&nbsp; &nbsp; &nbsp;
				原水藻类含量 :&nbsp;
				<input class="easyui-numberbox"  style="width:190px;height:25px" id="AlgaeContent" name="poolEvaluate.AlgaeContent" 
					data-options="prompt:'',precision:2" />
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				出 水 浊 度 : &nbsp;&nbsp;
				<input class="easyui-numberbox" style="width:200px;height:25px"  id="OutNTU" name="poolEvaluate.OutNTU"
					data-options="prompt:'',precision:2"  />
				<br/><br/>
				<!-- &nbsp; &nbsp;
				状&nbsp;态:&nbsp;
				...
				<!-- <input  size="10" id="state" name="poolEvaluate.state" /> -->
				
						
				&nbsp; &nbsp; &nbsp;
				预 加 氯 量 : &nbsp;
				<input class="easyui-numberbox" style="width:200px;height:25px" id="CL" name="poolEvaluate.CL"
					data-options="prompt:'',precision:2"  />
		...
		<div style="display:none">
		<div id="tabSearch" class="easyui-dialog"  data-options="closed:true" style="align:center;width:600px;height:400px;padding:10px 60px 20px 60px">
				<form id="frmSearch">
					...
					<br/>
					 ...
					 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
					    水 池 编 号 : &nbsp; <input  class="easyui-combobox" type="text" style="width:150px" id="searchPoolID" name="searchPoolID" />
					<br/><br/>
					...
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
					来 水 浊 度： &nbsp;  <input class="easyui-numberbox" id="lowNTU" name="lowNTU" style="width:60px" value="0" ></input> ~ 
							<input class="easyui-numberbox" id="highNTU" name="highNTU" style="width:60px" value="100" ></input>
					<br/><br/>
					
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
					来水藻类含量： &nbsp;  <input class="easyui-numberbox" id="lowAlgaeContent" name="lowAlgaeContent" style="width:60px" value="0" ></input> ~ 
							<input class="easyui-numberbox" id="highAlgaeContent" name="highAlgaeContent" style="width:60px" value="100" ></input>
					<br/><br/>
					
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
					出 水 浊 度：  &nbsp; <input class="easyui-numberbox" id="lowOutNTU" name="lowOutNTU" style="width:60px" value="0" ></input> ~ 
							<input class="easyui-numberbox" id="highOutNTU" name="highOutNTU" style="width:60px" value="100" ></input>
