...
$(document).ready(function() {
	$('#addButton').click(function(event) {
		...
		$('#tab').append(
			...
			+ "<td style='width:152px;height:26px'><input name='dataAnalysis.t' id='tAdd' type='datetime-local' style='width:188px;height:25px'/></td>"
			+ "<td style='width:102px;height:26px'><select name='dataAnalysis.PoolID' id='PoolIDAdd' style='width:100px;height:25px'><option value='MTG_QingS_SC01' selected='selected'>1# 清水池</option><option value='MTG_QingS_SC02'>2# 清水池</option><option value='MTG_QingS_SC03'>3# 清水池</option></select></td>"
